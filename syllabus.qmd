...
**Structure:** Lecture meets Mondays and Thursdays, 1:10-2:25pm in **Schow Classroom 030B**. Lab meets Mondays, 2:30-4:00pm in **Biology (TBL) 301**.

**Office Hours:** All office hours are held in my office, **TCL 308**, and come in two forms:

- **Drop-in (Wednesdays, 2:00-3:00pm).** No appointment needed. I will be in my office for the whole block; just stop by.
...
*[Piazza](https://piazza.com/williams/fall2026/cs382): content.* Use Piazza for anything technical: lecture material, problem sets, labs, or the project. Piazza handles code blocks and formal mathematical notation properly, which makes it much better suited to these questions than chat or email. Questions that are only loosely related to the course are welcome as well. Piazza also supports genuinely anonymous posting, so please use that if it makes a question easier to ask.

*[Slack](https://cs382.slack.com): casual/coordination.* Slack is the place for informal course questions, for discussion among yourselves, for setting up project team channels, for posting memes, and for coordinating study groups ahead of the midterm and final.
...
One practical consequence of the above: homework is due at 5:00pm, and I do not check messages over the weekend. **I make no promises about questions sent in the last day before a deadline, or over a weekend immediately preceding one.** For a Friday-due homework, that means asking by Thursday afternoon if you want a reliable answer. HW3 is due on **Tuesday, November 24**, so try to ask by **Friday, November 20**.
...
The midterm and final exams share a consistent format: a section of multiple-choice and true/false questions (similar in style to the weekly quizzes) and a section of lab-style problems (but easier). Students may also be asked to write some free-responses. The best preparation is thorough preparation for quizzes (doing well on quizzes is a good sign!) and reviewing the lab problems encountered throughout the semester.
...
Quiz solutions may be provided at my discretion ahead of the midterm and the final, ONLY during office hours. They will not be posted online. Do not ask me to post them, please.

To make up for this when preparing for your midterm / final, I will release a set of practice questions that look very much like quiz questions, for you to study with.
...
Outside of excused absences, which you should arrange over Slack and use sparingly, **each student gets one "freebie" lecture absence**. You do not need to explain it and I will not ask about it. Things come up in life. To set expectations: if you do message me with a request for an excused absence, and you have not yet used your "freebie," I will almost certainly respond by saying "That's totally fine," and also that you have now used your freebie.
...
- **Project:** Early on, minimal (outside of organizing your project group and ideating), but a lot towards the end of the semester. I encourage you to spread it out!
